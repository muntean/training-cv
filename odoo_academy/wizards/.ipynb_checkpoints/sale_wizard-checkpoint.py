...
class SaleWizard(models.TransientModel):
    ...
    session_id = fields.Many2one(comodel_name='academy.session', string='Session', required=True, default=default_session)
    
    
    session_student_ids = fields.Many2many(comodel_name='res.partner', string="Students in Current Session", 
                                           related="session_id.student_ids", help="These are the students currently in the Session")
